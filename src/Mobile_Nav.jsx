      ...
      {drawer ? (
        ...
        >
          <div className="mobile_navs">
            ...
            <div className="rowwing" onClick={() => navigate("/Hire")}>
              <FcBusinessContact className="icon" />
              <p>Hire</p>
            </div>{" "}
            <div className="rowwing" onClick={() => navigate("/Show_Room")}>
              <FcShop className="icon" />
              <p>Show Room</p>
            </div>
            <div className="rowwing" onClick={() => navigate("/Booking")}>
              <TbBrandBooking className="icon" />
              <p>Booking</p>
            </div>
            <div className="rowwing" onClick={() => navigate("/Blog")}>
              <GrBlog className="icon" />
              <p>Blog</p>
            </div>
            <div className="rowwing" onClick={() => navigate("/Clues")}>
