  ...
  return (
    ...
    >
      <main style={{ width: "50%" }}>
        ...
        <p>
          Below are members of a Termite colony and their roles. Queen Termite:
          The reproductive female, she starts the colony and lay eggs to be
          fertilized. The queen is the biggest member of the colony, is well
          developed and the only member with wings. She can have up to a hundred
          to thousands of eggs a day. There is usually one Queen in a colony,
          but 2-3 in large colonies.
        </p>
        <p>
          <b>King Termite:</b>
        </p>{" "}
        <p>
          ...
          the colony and are about 1-5% of the population. The have soft bodies
          like the workers but have strong mandibles used for defense. Workers
          and soldiers are all sterile and can be male or female. The young ones
          become workers or soldiers depending on the pheromones they are
          exposed to by the queen. The colony continues to increase massively
          for about 5 years before the queen has her first young kings and
          queens. They mature, prepare to swarm and leave to start another
          colony in the summer. This cycle continues over and over.
        </p>
        <p>
          <b> Causes</b>
        </p>{" "}
        ...
        <li>
          {" "}
          1. Presence of wood colored pellets of faces appearing like wood dust
          or shavings
        </li>
        ...
        <p>
          Evidences of presence of Termites may not show until month or years or
          their stay. The best way to protect your home and properties is to get
          regular inspection, say, every year from a pest control professional.
          They can spot even the slimmest signs of termites, saving you from
          bills from damaged properties. Get professional help to get rid of
          already noticed Termite infestation.
        </p>
      </main>
